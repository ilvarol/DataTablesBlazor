#pragma checksum "C:\Users\ilyas.varol\source\repos\DataTablesBlazor\DataTablesBlazor\Client\Components\DataTables\Column.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7117e86a1344ea74d5bf3ce3c082dbd2b049f897"
// <auto-generated/>
...
#line hidden
#nullable disable
    public partial class Column : ItemComponent<Column>
    {
...
#nullable restore
#line 3 "C:\Users\ilyas.varol\source\repos\DataTablesBlazor\DataTablesBlazor\Client\Components\DataTables\Column.razor"
                 InputAttributes
...
#nullable restore
#line 5 "C:\Users\ilyas.varol\source\repos\DataTablesBlazor\DataTablesBlazor\Client\Components\DataTables\Column.razor"
      

    private readonly string _sorting = "sorting";
    private readonly string _sorting_asc = "sorting_asc";
    private readonly string _sorting_desc = "sorting_desc";


    public void SetOrderDirectionClass()
    {
        if (IsCurrent)
            if (String.IsNullOrEmpty(Class))
                Class = _sorting_asc;
            else
                Class = Class.Contains(_sorting_asc) ? _sorting_desc :
                        Class.Contains(_sorting_desc) ? _sorting_asc : _sorting_asc;
        else
            Class = _sorting;
    }
